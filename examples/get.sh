...
scrap() {
    ...
    START="$3"
    END="$4"
    URL="https://www.airbnb.com/s/${LOCATION}/homes?flexible_trip_lengths%5B%5D=one_week&refinement_paths%5B%5D=%2Fhomes&tab_id=home_tab&date_picker_type=calendar&adults=6&source=structured_search_input_header&search_type=filter_change&pagination_search=true&l2_property_type_ids%5B%5D=3&room_types%5B%5D=Entire%20home%2Fapt&amenities%5B%5D=4&amenities%5B%5D=7&amenities%5B%5D=5&amenities%5B%5D=46&amenities%5B%5D=45&amenities%5B%5D=58&amenities%5B%5D=9&checkin=${START}&checkout=${END}"
